...
Em conjunto com essa class, trabalha o "XembedHelper":https://github.com/klawdyo/New-Spaghetti-Core/wiki/lib-helpers-XembedXelper, que facilita a inclusão dessas informações na página.
...
* "ESPN Brasil":http://espn.estadao.com.br/
